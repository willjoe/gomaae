    ...
    <aside className="w-56 border-r border-border flex flex-col bg-sidebar shadow-[4px_0_24px_rgba(0,0,0,0.05)] dark:shadow-[4px_0_24px_rgba(0,0,0,0.3)] z-[100] relative font-sans text-left transition-colors duration-300">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-2 space-y-8 custom-scrollbar">
         ...
         <div className="space-y-1">
            ...
            >
               <div className={cn('transition-colors', pathname === '/home' ? 'text-white' : 'text-muted-foreground group-hover:text-blue-500')}>
                 <LayoutDashboard size={18} />
               </div>
               <div className="flex flex-col text-left">
                 <span className="text-[11px] font-bold tracking-tight">Home</span>
                 <span className={cn('text-[8px] opacity-60 font-medium truncate w-24 tracking-tighter', pathname === '/home' ? 'text-blue-100' : 'text-muted-foreground')}>
                   Project overview
                 </span>
               </div>
            </Link>
