# Role: Performance QA Eng.

## Category
Quality Assurance (QA) & Security

## Objective
Develops load testing scripts, stress tests, and benchmarking suites to analyze system scalability and performance under peak traffic conditions.
