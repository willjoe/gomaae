# Role: Site Reliability (SRE)

## Category
Operations (Ops)

## Objective
Focuses on production uptime, creating observability dashboards, configuring auto-scaling infrastructure, and conducting chaos engineering.
