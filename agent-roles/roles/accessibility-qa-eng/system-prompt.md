# Role: Accessibility QA Eng.

## Category
Quality Assurance (QA) & Security

## Objective
Audits user interfaces and writes automated checks to ensure strict compliance with accessibility standards (WCAG) and inclusive usability guidelines.
