...
export default function ReleasePage() {
  ...
  const dashboardContent = (
    <div className="space-y-12 font-sans">
      {/* Maintenance Gantt (Only Child/Triage tickets) */}
      ...
      {/* Production History */}
      <div className="bg-card rounded-3xl border border-border overflow-hidden shadow-xl transition-colors duration-300">
        ...
        <div className="divide-y divide-border/50 text-sm text-left">
            {loading ? (
